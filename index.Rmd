...
org_raw <- load_org(2021:2022, all_of(covariates))
...
count_overall <- summarized |> 
  filter(group_name == "overall" & name == "under15_count_ma") |> 
  pull() |> 
  number(accuracy = 0.1)

share_overall <- summarized |> 
...
Data from the EPI extracts of the CPS-ORG, `r date_range`.

<div class = "row">
<div class = "col-md-8">
```{r}
bar_plot(summarized, "wbhao", "Race")
```
</div>
<div class = "col-md-4">
```{r}
table_counts(summarized, "wbhao", "Race")
```
</div>
</div>
...
<div class = "col-md-8">
```{r}
bar_plot(summarized, "female", "Gender")
```
</div>
<div class = "col-md-4">
```{r}
table_counts(summarized, "female", "Gender")
```
</div>
</div>
...
<div class = "col-md-8">
```{r}
bar_plot(summarized, "educ", "Education")
```
</div>
<div class = "col-md-4">
```{r}
table_counts(summarized, "educ", "Education")
```
</div>
</div>
...
<div class = "col-md-8">
```{r}
bar_plot(summarized, "region", "Census region")
```
</div>
<div class = "col-md-4">
```{r}
table_counts(summarized, "region", "Census region")
```
</div>
</div>
